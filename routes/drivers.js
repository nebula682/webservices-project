...
// Protect POST, PUT, DELETE with authentication middleware
router.post('/', isAuthenticated, driversValidation, driversController.createDriver);
router.put('/:id', isAuthenticated, driversValidation, driversController.updateDriver);
router.delete('/:id', isAuthenticated, driversController.deleteDriver);
